...
+ (BOOL) wordsetFor:(NSString *) lang
{
    NSStringEncoding encoding;
    NSError *error;
    NSString *fileName = [[[[[NSBundle mainBundle] pathForResource:@"IODProfanityWords" ofType:@"txt"] stringByDeletingLastPathComponent] stringByDeletingLastPathComponent] stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.lproj/IODProfanityWords.txt", lang]];
